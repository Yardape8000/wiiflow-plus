#define APP_NAME				"WiiFlow Plus"
#define APP_VERSION				"3.0a3"

#define APPDATA_DIR				"wiiflow_plus"
#define APPDATA_DIR2			"apps/wiiflow_plus"

#define GAMES_DIR 				"%s:/wbfs"
#define HOMEBREW_DIR 			"%s:/apps"
#define CFG_FILENAME			"wiiflow_plus.ini"
...
OverjoY, FIX94, Crediar, stfour, Yardape8000 \
